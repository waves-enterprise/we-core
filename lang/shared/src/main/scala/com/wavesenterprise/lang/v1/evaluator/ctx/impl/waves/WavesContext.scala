...
import com.wavesenterprise.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
...
import com.wavesenterprise.lang.v1.traits.domain.{OrdType, Recipient}
...
object WavesContext {
  ...
  def build(version: ScriptVersion, env: Environment, isTokenContext: Boolean): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.wavesenterprise.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.l)
    ...
    val commonVars = Map(
      ("height", ((com.wavesenterprise.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
