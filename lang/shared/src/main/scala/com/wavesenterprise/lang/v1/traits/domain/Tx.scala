...
object Tx {
  ...
  case class CreateContract(p: Proven)                                                                                                extends Tx
  case class CallContract(p: Proven, contractId: ByteVector, contractVersion: Long)                                                   extends Tx
  case class DisableContract(p: Proven, contractId: ByteVector)                                                                       extends Tx
